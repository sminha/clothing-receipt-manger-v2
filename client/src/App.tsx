...
import ViewOrdersPage from './pages/orders/view/ViewOrders.tsx';
import AddOrderPage from './pages/orders/add/AddOrder.tsx';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/view" element={<ViewOrdersPage />} />
